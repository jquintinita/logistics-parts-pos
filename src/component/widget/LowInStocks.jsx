...
export default function LowInStock({ datas }) {
    return (
        <div className="w-full h-full overflow-hidden bg-gray-300 dark:bg-stone-800 rounded-2xl pl-2 pr-1 py-2 flex flex-col gap-1 relative">
            ...
            <div className="flex-1  max-h-[500px] xl:max-h-[20vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-200  dark:scrollbar-thumb-zinc-800 dark:scrollbar-track-stone-800 pr-1 pt-3">
